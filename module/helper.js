...
export class EntitySheetHelper {
  ...
  static onAttributeRoll(event) {
    ...
    const shorthand = game.settings.get("wulin", "macroShorthand");
  ...
  static async createDialog(data={}, options={}) {
    ...
    const templates = collection.filter(a => a.getFlag("wulin", "isTemplate"));
    ...
    const useEntity = game.wulin.useEntity;
    ...
    return Dialog.prompt({
      ...
      callback: html => {
        ...
        if ( template ) {
          ...
          delete createData.flags.wulin.isTemplate;
        }
